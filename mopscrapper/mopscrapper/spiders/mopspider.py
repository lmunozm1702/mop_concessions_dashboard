...
class MopspiderSpider(scrapy.Spider):
    ...
    start_urls = [
        "https://concesiones.mop.gob.cl/proyectos/Paginas/construccion.aspx",
        ...
        "https://concesiones.mop.gob.cl/proyectos/Paginas/Cartera_de_Concesiones_2022_2026.aspx",
    ]

    def parse(self, response):
        pages = response.css("li")
        for page in pages:        
            if page.css("a::attr(href)").get() is not None :                
